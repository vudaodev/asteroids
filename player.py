...
class Player(CircleShape):
    ...
    def shoot(self):
        ...
        new_shot = Shot(self.position.x + rotated_vector.x * self.radius, self.position.y + rotated_vector.y * self.radius ) #Create a new Shot at the current position of player 
